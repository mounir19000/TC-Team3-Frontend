  ...
  return (
    <>
      <div className="flex flex-col items-center justify-center h-[100vh]">
        <img className='mb-12' src={Logo} alt="Doc Space Logo" />
        ...
        <div className="flex space-x-5">
          <Link to="/" className="bg-[#00CED0] h-12 py-1 px-12 rounded-xl">
            <h1 className="text-[#ffffff] py-2">
              Go to homepage
            </h1>
          </Link>
          <Link to="/contact" className="bg-[#FFFFFF] h-12 py-1 px-12 rounded-xl">
            <h1 className="text-[#26BFA6] py-2">
              Contact us
            </h1>
          </Link>
        </div>
